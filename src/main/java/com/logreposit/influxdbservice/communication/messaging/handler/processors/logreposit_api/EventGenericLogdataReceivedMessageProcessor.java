...
@Component
public class EventGenericLogdataReceivedMessageProcessor extends AbstractMessageProcessor<List<ReadingDto>>
{
    private static final Logger logger = LoggerFactory.getLogger(EventGenericLogdataReceivedMessageProcessor.class);

    private final InfluxDBService              influxDBService;
    private final GenericLogdataBatchPointsFactory genericLogdataBatchPointsFactory;

    @Autowired
    public EventGenericLogdataReceivedMessageProcessor(ObjectMapper objectMapper,
    ...
    public void processMessage(Message message) throws MessagingException
    {
        ...
        List<ReadingDto> logData  = this.getMessagePayload(message, new TypeReference<List<ReadingDto>>() {});
        ...
        try
        {
            BatchPoints batchPoints = this.genericLogdataBatchPointsFactory.createBatchPoints(deviceId, logData);
